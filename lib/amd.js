...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".evil"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
<title>Bouncing Text - EVIL-MD-V2</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">EVIL-MD-V2</div>
