...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is Dark Evil");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is Dark Evil");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x4f2076 || !_0x536d9f.includes(_0x4f2076?.mtype || "null")) {
      return await _0x28a796.send("*_I'm Dark Evil Dear, Reply to an image_*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x5ea4b8) {
      _0x5ea4b8 = "*I'm Dark Evil Dear,Please provide text*\n*Eg:- _.readmor text1 readmore text2_*";
    } else {
      _0x5ea4b8 += " ";
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x680da4 || !pmtypes.includes(_0x680da4?.mtype)) {
      return _0x4e4351.reply("*_I'm Dark Evil Dear, Reply To An Image/Video!_*");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x7d6de1 || !pmtypes.includes(_0x7d6de1?.mtype)) {
      return _0xbda24.reply("*_I'm Dark Evil Dear, Reply To An Image/Video!_*");
    }
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Rahman97097/EVIL-MD-V2");
    let _0x1c73f9 = ("\nEVIL-MD-V2 AN CHUDDY BUDDY BOT FOR ENJOYMENT *" + Config.ownername + "*.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲❒❳ Authors:* Dark Evil\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* _https://github.com/Rahman97097/EVIL-MD-V2_\n  *❲❒❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  use: "2331979097xx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*EVIL-MD-V2• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("EVIL-MD-V2• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("EVIL-MD-V2• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
