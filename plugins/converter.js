...
smd({
  ...
  try {
    ...
    if (_0x4a2c9b && mtypes.includes(_0x4a2c9b?.mtype || "need_Media")) {
      ...
      return _0x5f0a63.reply("*_I'm Dark Evil Dear, Reply to image/video!!_*");
    }
  } catch (_0xb1d121) {
...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "𝐄𝐯𝐢𝐥 𝐦𝐝 𝐯2 😍";
...
smd({
  ...
  try {
    ...
    if (_0x2d0760 && mtypes.includes(_0x2d0760?.mtype || "need_Media")) {
      ...
      return _0x50fc92.reply("*_I'm Dark Evil Dear, Reply to image!!_*");
    }
  } catch (_0x1c7f0b) {
...
smd({
  ...
  try {
    ...
    if (_0x11d586 && mtypes.includes(_0x11d586?.mtype || "need_Media")) {
      ...
      return _0x52caf7.reply("*_I'm Dark Evil Dear, Reply to image!!_*");
    }
  } catch (_0x165b2a) {
...
smd({
  ...
  try {
    ...
    if (_0x5f32a5 && mtypes.includes(_0x5f32a5?.mtype || "need_Media")) {
      ...
      return _0x37c100.reply("*_I'm Dark Evil Dear, Reply to an image!!_*");
    }
  } catch (_0x52baa5) {
...
smd({
  ...
  try {
    ...
    if (!_0x5b20bd || !pmtypes.includes(_0x5b20bd.mtype)) {
      return _0x29b369.reply("*_I'm Dark Evil please, Reply to an image*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x5a2037 || !_0x8d0e84) {
      return _0xa1cfa2.reply("*_I'm Dark Evil Please quote/reply to any message!!!_*");
    }
...
smd({
  ...
  try {
    ...
    if (isNaN(_0x50c7d9)) {
      let _0x4ca942 = _0x3b568a ? _0x3b568a : "evil-md";
...
smd({
  ...
  try {
    ...
    if (!_0x2976f2 || !audtypes.includes(_0x2976f2?.mtype)) {
      return _0x116242.reply("*_I'm Dark Evil Dear, Reply to Any Video.!!_*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x462db2 || !audtypes.includes(_0x462db2?.mtype)) {
      return _0x5c9aa3.reply("*_I'm Dark Evil Please, Reply to audio/video_*");
    }
...
smd({
  ...
  if (!asta_mp4) {
    return m.reply("*_I'm Dark Evil Dear, Reply To Animated Sticker or Gif!!_*");
  }
  const {
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_I'm Dark Evil Dear, provide text, ex .ttp 4 hii im evil md!!_*");
    }
  } catch (_0x72e5d) {
