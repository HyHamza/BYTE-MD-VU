let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝐑𝐀𝐇𝐌𝐀𝐍 𝐓𝐄𝐂𝐇 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029Va8TzeF0AgW8dVET3U1w\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝐄𝐕𝐈𝐋 𝐌𝐃 𝐕2 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *𝐋𝐈𝐍𝐊:*https://chat.whatsapp.com/JvaJHe9m6N6CMWqTRSAcbp \n\n ${Config.botname} *WORKS*`;
 ...
 let tmpUrl = "https://telegra.ph/file/0ef696e8a431e81973eda.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
